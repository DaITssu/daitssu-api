...
enum class ErrorCode(val code: Int, val message: String) {
    ...
    COURSE_NOT_FOUND(MAIN_NUMBERING + 1001, "과목을 찾을 수 없습니다."),
    INVALID_DATE_FORMAT(MAIN_NUMBERING + 1002, "잘못된 날짜 형식입니다. yyyy-MM-dd HH:mm:ss 형식으로 요청바랍니다."),
    INVALID_DATE(MAIN_NUMBERING + 1003, "잘못된 날짜입니다."),
