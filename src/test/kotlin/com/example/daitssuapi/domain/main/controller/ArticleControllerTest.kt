...
class ArticleControllerTest(
    ...
    fun article_post_controller_success() {
        ...
        val json = jacksonObjectMapper().writeValueAsString(articleCreateRequest)
        ...
        mockMvc.perform(
            ...
            .andExpect(content().contentType(MediaType.APPLICATION_JSON))
            .andExpect(jsonPath("$.data.title").value(articleCreateRequest.title))
            .andExpect(jsonPath("$.data.content").value(articleCreateRequest.content))
            .andExpect(jsonPath("$.data.writerNickName").value(user.nickname))
            .andExpect(jsonPath("$.data.topic").value(articleCreateRequest.topic.value))
    }
